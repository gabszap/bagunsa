...
directories = {
    "root": f"{home}/Downloads/stable-diffusion-webui-forge",
    "lora": f"{home}/Downloads/stable-diffusion-webui-forge/models/lora",
    "ad": f"{home}/Downloads/stable-diffusion-webui-forge/models/adetailer",
    "hub": f"{home}/sDownloads/table-diffusion-webui-forge/extensions/sd-hub",
    "cfpreset": f"{home}/Downloads/stable-diffusion-webui-forge/extensions/Config-Presets",
    "ups": f"{home}/Downloads/stable-diffusion-webui-forge/models/ESRGAN",
    "emb": f"{home}/Downloads/stable-diffusion-webui-forge/models/embeddings",
    "cn": f"{home}/Downloads/stable-diffusion-webui-forge/models/controlnet",
    "vae": f"{home}/Downloads/stable-diffusion-webui-forge/models/vae",
}
...
def download_file(url, dest_path, retries=3):
    ...
    if "civitai.com" in url:
        ...
        url = f"{url}{separator}token={CIVITAI_API_TOKEN}"
